...
export const MAJLIS_ANCHOR = Object.freeze({
  ...
  main_sofa: 'A light-sand modern L-shape sofa runs along the RIGHT wall as one connected piece, with three separate seat cushions, four square back cushions, and short wooden legs. All cushions are plain solid light-sand woven fabric with no tufting, no buttons, no quilted pattern, no decorative seams, and no contrasting fabric. The back of the L-shape sofa is flush against the RIGHT wall with no visible floor gap between the sofa back and the wall.',
