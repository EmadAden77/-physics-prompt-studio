...
export const MAJLIS_ANCHOR = Object.freeze({
  ...
  main_sofa: 'A light-sand modern L-shape sofa runs along the RIGHT wall as one connected piece, with three separate seat cushions, four square back cushions, and short wooden legs. All cushions share the same solid light-sand upholstery with no pattern, print, or contrasting fabric. The back of the L-shape sofa is flush against the RIGHT wall with no visible floor gap between the sofa back and the wall.',
