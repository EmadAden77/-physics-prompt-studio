...
const POSE_FURNITURE_SEMANTICS = Object.freeze({
  ...
  sofa:new Set(['seated_sofa']), chair:new Set(['seated_chair','seated_legs_crossed','seated_elbow_on_table','seated_leaning_forward','seated_reading_posture']), counter:new Set(['lean_counter','lean_railing']),
  none:new Set(['standing_relaxed','standing_one_hand','walking_slow','driver_seat','passenger_seat','door_open_car','standing_arms_crossed','standing_hands_in_pockets','standing_looking_away','walking_looking_back','standing_stretching','standing_hand_on_hip','leaning_against_wall','bedroom-stand-relaxed','bedroom-floor-cross','bedroom-floor-back-wall','bedroom-floor-knee-up'])
});
...
export const CLOTHING_STYLING = Object.freeze({
  ...
  abaya: Object.freeze([
    { value:'abaya-closed', label:'مغلقة', prompt:'Keep the abaya closed down the front with a continuous modest silhouette, realistic seam alignment, sleeve drape, and matte fabric response.', applicableTo:['long-garment'] },
    { value:'abaya-front-open', label:'مفتوحة من الأمام', prompt:'Wear the abaya open from the front with two physically separate front panels hanging naturally under gravity and an appropriate inner layer visible beneath.', applicableTo:['long-garment'] }
  ]),
  suit: Object.freeze([
...
export const CLOTHING_STYLING_CATEGORIES = Object.freeze(['thobe','shirt','tshirt','bisht','abaya','suit']);
