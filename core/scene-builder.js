...
{ group:'استلقاء على السرير', value:'bed-lying-stomach', label:'مستلقٍ على بطنه', prompt:'lying on his stomach on the bed with chest and hips compressing the mattress, supported by the free forearm while the other arm alone holds the phone; feet rest naturally on the mattress', cameraHint:'front camera held within reach slightly above the pillow, lens pointing back at the face; only the free forearm props the chest' },
...
{ group:'استلقاء على السرير', value:'bed-lying-partial', label:'مستلقٍ نصف استلقاء', prompt:'half-lying on the bed with pelvis and back compressing the mattress, one knee bent and foot resting on the mattress; upper body is supported by the free elbow while the other arm alone holds the phone', cameraHint:'front camera held within reach at chest height while half-lying, slight downward pitch' },
...
{ group:'استلقاء على السرير', value:'bed-lying-reading', label:'مستلقٍ يقرأ كتابًا', prompt:'lying on the fixed bed with shoulders and pelvis compressing the mattress and head supported by a locally compressed pillow; an open book rests partly on the torso and is steadied by the free hand while the other hand alone holds the phone', cameraHint:'front camera held within reach slightly above the face, book on torso steadied by the free hand' },
